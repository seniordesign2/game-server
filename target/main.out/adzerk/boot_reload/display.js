...
return (function (p__6992){
var vec__6993 = p__6992;
var attr = cljs.core.nth.call(null,vec__6993,(0),null);
var v = cljs.core.nth.call(null,vec__6993,(1),null);
...
var args6994 = [];
var len__6046__auto___6997 = arguments.length;
var i__6047__auto___6998 = (0);
while(true){
if((i__6047__auto___6998 < len__6046__auto___6997)){
args6994.push((arguments[i__6047__auto___6998]));

var G__6999 = (i__6047__auto___6998 + (1));
i__6047__auto___6998 = G__6999;
continue;
} else {
}
break;
...
var len__6046__auto___7002 = arguments.length;
var i__6047__auto___7003 = (0);
while(true){
if((i__6047__auto___7003 < len__6046__auto___7002)){
args__6053__auto__.push((arguments[i__6047__auto___7003]));

var G__7004 = (i__6047__auto___7003 + (1));
i__6047__auto___7003 = G__7004;
continue;
} else {
}
break;
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq7001){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq7001));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__7005){
var map__7009 = p__7005;
var map__7009__$1 = ((((!((map__7009 == null)))?((((map__7009.cljs$lang$protocol_mask$partition0$ & (64))) || (map__7009.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__7009):map__7009);
var data = map__7009__$1;
var message = cljs.core.get.call(null,map__7009__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__7009__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__7009__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__7011 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__7011,goog.events.EventType.CLICK,((function (G__7011,map__7009,map__7009__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__7011,map__7009,map__7009__$1,data,message,line,file))
);

return G__7011;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__7012){
var map__7016 = p__7012;
var map__7016__$1 = ((((!((map__7016 == null)))?((((map__7016.cljs$lang$protocol_mask$partition0$ & (64))) || (map__7016.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__7016):map__7016);
var data = map__7016__$1;
var message = cljs.core.get.call(null,map__7016__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__7016__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__7016__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__7018 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),message),adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),[cljs.core.str("at line "),cljs.core.str(line)].join('')),adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),file)], null));
goog.events.listen(G__7018,goog.events.EventType.CLICK,((function (G__7018,map__7016,map__7016__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__7018,map__7016,map__7016__$1,data,message,line,file))
);
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__7019){
var map__7023 = p__7019;
...
var G__7025 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__7025,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),goog.dom.htmlToDocumentFragment(adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__7025,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__7026){
var map__7029 = p__7026;
var map__7029__$1 = ((((!((map__7029 == null)))?((((map__7029.cljs$lang$protocol_mask$partition0$ & (64))) || (map__7029.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__7029):map__7029);
var messages = map__7029__$1;
var warnings = cljs.core.get.call(null,map__7029__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__7029__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__7029,map__7029__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__7029,map__7029__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__7029,map__7029__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__7029,map__7029__$1,messages,warnings,exception))
;
